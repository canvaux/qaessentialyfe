                ...
                <div class="tab-content">
                  <div class="tab-pane fade show active" id="tabs-4-1">
                    ...
                    <article class="progress-linear progress-secondary">
                      <a class="button button-secondary button-md" href="about">Get in Touch</a>
                    </article>
                  </div>
        ...
        <div class="col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3 mb-3 mb-lg-0">
          <div class="card">
            ...
            <h3 class="card-text text-center about-card-name_first ">Avi Shabtai</h3>
              ...
              <p class="card-text text-center about-card  mt-2 about_card_bio ">Experienced CEO with a demonstrated history of working in the retail industry. Skilled in Negotiation, Customer Service, Retail, Sales, and Strategic Planning. Strong business development professional graduated from Shenkar - Engineering. Design. Art.</p>
              <p class="card-text text-center about-card about_card_hobbies ">Chess l Tennis l Travel</p>
              <p class="card-text text-center about-card about_card_email">avi@essentialyfe.com</p>
            </div>
          </div>
        </div>
        <div class="col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3 mb-3 mb-lg-0">
          <div class="card">
            ...
            <h3 class="card-text text-center about-card-name_first">Jhon</h3>
              ...
              <p class="card-text text-center about-card  mt-2 ">Lorem ipsum dolor sit amet.</p>
              <p class="card-text text-center about-card  about_card_hobbies">Learning New things</p>
              <p class="card-text text-center about-card about_card_email">Jhon@gmail.com</p>
            </div>
          </div>
        </div>
        <div class="col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3 mb-3 mb-lg-0">
          <div class="card">
            ...
            <h3 class="card-text text-center about-card-name_first">Jhon</h3>
              ...
              <p class="card-text text-center about-card  mt-2 ">Lorem ipsum dolor sit amet.</p>
              <p class="card-text text-center about-card  about_card_hobbies">Learning New things</p>
              <p class="card-text text-center about-card about_card_email">Avi Shabtai@gmail.com</p>
            </div>
          </div>
        </div>
      <div class="col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3 mb-3 mb-lg-0">
