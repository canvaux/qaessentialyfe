...
if (isset($_POST['login'])) {
    $username = stripslashes(trim(strtolower(mysqli_real_escape_string($conn, $_POST['username'])))) ;
                ...
                <div class="row">
                    <div class="col-10 mx-auto login_form">
                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST">
                            ...
                            <div class="form-group mt-3">
                                <p><a href="./reset_pass.php" style="color: #000; text-decoration:none;">Forget Password?</a></p>
                            </div>
                        </form>
                    </div>
                </div>
